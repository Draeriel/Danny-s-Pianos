...
//};
    ...
    if(document.getElementById("Ordenar") != null && localStorage.getItem("selectOrden") != null && document.title != "Compras" ){
         console.log(document.title);
...
window.onresize = function(){ 
    //var w = window.innerWidth-36;
    //document.getElementById("hiddenIndex").style.marginLeft=w.toString+"px";
    location.reload(); }
...
function usar(){
    ...
    if(document.title=="Compras"){
        console.log("hiddenIindex")
